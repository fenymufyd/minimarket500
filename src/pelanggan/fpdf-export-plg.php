<?php
    ...
    $pdf->ln();
    $pdf->ln();
    $pdf->Cell(27, 0.7, "Laporan Data Pelanggan", 0, 1, "C");
    $pdf->ln();

    $pdf->SetFillColor(255,0,0);
    $pdf->Cell(1, 0.7, "#", 1, 0, "C", true);
    $pdf->Cell(4, 0.7, "ID pelanggan", 1, 0, "C", true);
    $pdf->Cell(5, 0.7, "Nama pelanggan", 1, 0, "C", true);
    $pdf->Cell(6, 0.7, "Email", 1, 0, "C", true);
    $pdf->Cell(4, 0.7, "Password", 1, 0, "C", true);
    $pdf->Cell(4, 0.7, "Telepon", 1, 0, "C", true);
    $pdf->Cell(4, 0.7, "TTL", 1, 1, "C", true);
    ...
    while($data = mysqli_fetch_array($result)){
        ...
        $pdf->Cell(5, 0.7, $data[1], 1, 0, "L");
        $pdf->Cell(6, 0.7, $data[2], 1, 0, "L");
        $pdf->Cell(4, 0.7, $data[3], 1, 0, "L");
        $pdf->Cell(4, 0.7, $data[4], 1, 0, "L");
        $pdf->Cell(4, 0.7, $data[5], 1, 1, "L");
    }
