<?php
	...
	if (empty($_GET['id'])) {
		...
		$idUpdate =	$_GET['id'];
		$query = "SELECT * FROM pelanggan WHERE id_pelanggan='$idUpdate'";
        ...
        if (count($errors) == 0) {
          ...
          $a      = 1;
            $query  = "UPDATE pelanggan
                      SET id_pelanggan='$id', nama='$username', email='$email', 
					  password='$password_1', telepon='$tlp', tanggal='$tgl',level='$a'
          ...
          if($result){
            ...
            echo "<script type='text/javascript'>alert('berhasil diubah');
              ...
              echo "<a href='?page=plg'>Kembali</a>";
          }
        }
      }
?>
    <div class="container center" style="padding-top:20px;">
        ...
        <?php include('src/akun/errors.php'); ?>
				<div class="row" style="margin-top:20px;">
                    ...
                    <input id="idpq" name="idp" type="text" readonly 
					value="<?= $_GET['id'] ?>">
                    <label for="idpq">ID Pelanggan</label>
                    </div>
                </div>
                <div class="row" style="margin-top:20px;">
                    <div class="input-field col s12">
